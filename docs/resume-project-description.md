...
governance, an Australian macro-credit satellite, independent validation, and remediation.
...
public Australian macro satellite with fixed-input ECL A/B sensitivity, a six-case
contractual cash-flow/recovery sensitivity with account attribution, and a
...
retest and formal closure. The ECL and validation
...
> deterministic evidence, and governance persistence; independently restricted an Australian
> macro satellite after it missed frozen MAE/RMSE persistence benchmarks and lacked
> release-date macro vintages.
...
> benchmark failure; added macro and management-overlay controls that quantified a 16.54% downside impact,
